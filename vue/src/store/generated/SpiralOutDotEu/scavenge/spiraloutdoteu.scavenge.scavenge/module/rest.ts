...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/SpiralOutDotEu/scavenge/scavenge/commit
   */
  queryCommitAll = (
    query?: {
    ...
    this.request<ScavengeQueryAllCommitResponse, RpcStatus>({
      path: `/SpiralOutDotEu/scavenge/scavenge/commit`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/SpiralOutDotEu/scavenge/scavenge/commit/{index}
   */
  queryCommit = (index: string, params: RequestParams = {}) =>
    this.request<ScavengeQueryGetCommitResponse, RpcStatus>({
      path: `/SpiralOutDotEu/scavenge/scavenge/commit/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/SpiralOutDotEu/scavenge/scavenge/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<ScavengeQueryParamsResponse, RpcStatus>({
      path: `/SpiralOutDotEu/scavenge/scavenge/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/SpiralOutDotEu/scavenge/scavenge/scavenge
   */
  queryScavengeAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ScavengeQueryAllScavengeResponse, RpcStatus>({
      path: `/SpiralOutDotEu/scavenge/scavenge/scavenge`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/SpiralOutDotEu/scavenge/scavenge/scavenge/{index}
   */
  queryScavenge = (index: string, params: RequestParams = {}) =>
    this.request<ScavengeQueryGetScavengeResponse, RpcStatus>({
      path: `/SpiralOutDotEu/scavenge/scavenge/scavenge/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
